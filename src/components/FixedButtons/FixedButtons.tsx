...
function FixedButtons() {
  ...
  return (
    <div className="fixed-buttons">
      {/* Botão WhatsApp */}
      <a href="#" target="_blank" rel="noopener noreferrer" className="button whatsapp-button" aria-label="WhatsApp">
        <svg xmlns="http://www.w3.org/2000/svg" width="2489" height="2500" viewBox="0 0 737.509 740.824" id="whatsapp">
