    ...
    <>
      <div id="clientes" className="clientes">
          ...
          <div className="feedback">
            <div className="cabecalho-feedback">
              ...
              <div className="nome-avaliacao">
                <div className="nome">Nome do Cliente</div>
                <div className="avaliacao">
                  <img src="src/assets/images/clientes/flash.svg" alt="Flash" />
                  <img src="src/assets/images/clientes/flash.svg" alt="Flash" />
                  <img src="src/assets/images/clientes/flash.svg" alt="Flash" />
                  <img src="src/assets/images/clientes/flash-outline.svg" alt="Flash" />
                  <img src="src/assets/images/clientes/flash-outline.svg" alt="Flash" />
                </div>
              </div>
            </div>
        ...
        <div className="header-clientes">
          ...
          <div className="titulo-clientes">Feedbacks</div>
          <div className="subtitulo-clientes">O que nossos clientes dizem...</div>
        </div>
      </div>
    </>
  )
